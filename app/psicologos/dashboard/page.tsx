      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 bg-gradient-to-b from-slate-50 to-indigo-50 dark:from-indigo-950 dark:to-indigo-900 min-h-screen">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-start">
            <Card className="w-full md:w-2/3 bg-white dark:bg-indigo-900/50 border-indigo-100 dark:border-indigo-800">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {stats.map((stat, index) => (
                    <div key={index} className="flex flex-col p-4 rounded-lg border border-indigo-100 dark:border-indigo-800 bg-white dark:bg-indigo-950/50">
                      ...
                      <div className="flex items-end justify-between">
                        <span className="text-2xl font-bold text-indigo-900 dark:text-indigo-100">{stat.value}</span>
            ...
            <Card className="w-full md:w-1/3 bg-gradient-to-br from-indigo-600 to-indigo-800 text-white border-none">
              <CardHeader className="pb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card className="md:col-span-2 bg-white dark:bg-indigo-900/50 border-indigo-100 dark:border-indigo-800">
              <CardHeader className="pb-2">
              ...
              <CardContent>
                <div className="space-y-3">
                  {upcomingAppointments.map((appointment, index) => (
                    <div key={index} className="flex items-center justify-between p-3 rounded-lg border border-indigo-100 dark:border-indigo-800 hover:bg-indigo-50 dark:hover:bg-indigo-800/50 transition-colors">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-indigo-900 dark:text-indigo-100">{appointment.patient}</div>
                  ...
                  <button className="w-full mt-2 bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-800/50 dark:hover:bg-indigo-800 text-indigo-600 dark:text-indigo-300 rounded-md py-2 text-sm font-medium transition-colors">
              ...
              <CardContent>
                <div className="space-y-3">
                  {recentActivities.map((activity, index) => (
                    <div key={index} className="flex items-start gap-3 p-3 rounded-lg border border-indigo-100 dark:border-indigo-800 hover:bg-indigo-50 dark:hover:bg-indigo-800/50 transition-colors">
                      <div className={`p-2 rounded-md ${activity.color}`}>
                        <activity.icon className="h-4 w-4" />
                      </div>
                      <div>
                        <div className="font-medium text-indigo-900 dark:text-indigo-100">{activity.type}</div>
          ...
          <Card className="bg-white dark:bg-indigo-900/50 border-indigo-100 dark:border-indigo-800">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="col-span-2 h-64 rounded-lg border border-indigo-100 dark:border-indigo-800 bg-indigo-50/50 dark:bg-indigo-950/50 flex items-center justify-center">
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-lg border border-indigo-100 dark:border-indigo-800 bg-white dark:bg-indigo-950/50">
                    <div className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Faixa Etária</div>
                    <div className="flex items-center justify-between">
                      <span className="text-lg font-bold text-indigo-900 dark:text-indigo-100">18-35 anos</span>
                      <span className="text-sm text-indigo-600 dark:text-indigo-400">65%</span>
                    </div>
                  </div>
                  <div className="p-4 rounded-lg border border-indigo-100 dark:border-indigo-800 bg-white dark:bg-indigo-950/50">
                    <div className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Gênero</div>
                    <div className="flex items-center justify-between">
                      <span className="text-lg font-bold text-indigo-900 dark:text-indigo-100">Feminino</span>
                      <span className="text-sm text-indigo-600 dark:text-indigo-400">58%</span>
                    </div>
                  </div>
                  <div className="p-4 rounded-lg border border-indigo-100 dark:border-indigo-800 bg-white dark:bg-indigo-950/50">
                    <div className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Novos Pacientes</div>
                    <div className="flex items-center justify-between">
                      <span className="text-lg font-bold text-indigo-900 dark:text-indigo-100">5 pacientes</span>
